...
W '  cites Foreword chapter Wrap64'
W ''
...
W ' without changing the answer under test. The bit patterns of two negative'
W ' doubles already sum past i64-min, so the sum goes through w64-add: a plain'
W ' Integer + traps on overflow (COMPILER-36).'
W ''
...
W '   in let r = v / w'
W '   in let m = v < w'
W '   in w64-add (w64-add (w64-add (real-to-bits (vec-extract p 0)) (real-to-bits (vec-extract q 1))) (real-to-bits (vec-extract r 0))) (mask-count m)'
W ''
