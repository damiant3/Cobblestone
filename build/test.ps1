...
# ===========================================================================
$buckets = @{
    PASS_EXPECTED = @(); PASS_UNVERIFIED = @(); PASS_FAILING = @(); PASS_DIAG = @()
...
$passed = $buckets.PASS_EXPECTED.Count + $buckets.PASS_FAILING.Count + $buckets.PASS_UNVERIFIED.Count + $buckets.PASS_DIAG.Count
$unexpected = $buckets.FAIL_COMPILE.Count + $buckets.FAIL_EXPECTED_BUT_COMPILED.Count `
            ...
            + $buckets.FAIL_MISSING_DIAGNOSTIC.Count
