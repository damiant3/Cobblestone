...
if ($script:UseCodexVm) {
    ...
    $proc = Start-Process -FilePath $script:FallbackVmBin -ArgumentList $qemuArgs -PassThru -WindowStyle Hidden -RedirectStandardOutput $stdoutFile -RedirectStandardError $stderrFile
