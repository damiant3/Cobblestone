...
$PerfPat = '(?i)(constant.time|work factor|attacker|timing attack|crackab|side.channel|throughput|hot path|cache line|heap|allocation|fuel cap|blow.?up|quadratic|amortis|amortiz)'
