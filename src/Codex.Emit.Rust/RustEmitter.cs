...
public sealed class RustEmitter : IRExprTextEmitter, ICodeEmitter
{
    ...
    {
        string name = def.Name == Names.OpeningEntryPoint ? "codex_main" : Sanitize(def.Name);
    ...
    protected override void EmitFuelExhaustedToken(StringBuilder sb) => sb.Append("todo!()");

    protected override void EmitUnhandled(StringBuilder sb, IRExpr expr, int indent) => sb.Append("todo!()");
    ...
    static string Sanitize(string name) =>
        NameSanitizer.Sanitize(name, s_reservedKeywords, escapePrefix: "r#");

    static readonly HashSet<string> s_reservedKeywords =
    [
        "fn", "let", "mut", "pub", "struct", "enum", "impl", "trait",
        "type", "use", "mod", "crate", "self", "super", "where",
        "match", "if", "else", "for", "while", "loop", "break",
        "continue", "return", "move", "ref", "as", "in", "true",
        "false", "const", "static", "unsafe", "extern", "async",
        "await", "dyn", "abstract", "become", "box", "do", "final",
        "macro", "override", "priv", "try", "typeof", "virtual",
        "yield",
    ];
