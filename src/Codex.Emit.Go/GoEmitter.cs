...
public sealed class GoEmitter : IRExprTextEmitter, ICodeEmitter
{
    ...
    protected override void EmitFuelExhaustedToken(StringBuilder sb) => sb.Append("nil");

    protected override void EmitUnhandled(StringBuilder sb, IRExpr expr, int indent) => sb.Append("nil");
    ...
    [
        ...
        "chan", "go", "select", "defer", "range", "return", "if",
        "else", "for", "switch", "case", "break", "continue", "default",
        "package", "import", "fallthrough", "goto",
    ];
