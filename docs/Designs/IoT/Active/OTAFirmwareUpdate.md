...
**Status**: Partially shipped -- OtaUpdate foreword + ota-state-machine / ota-update tests live. Pending: LwM2M Object 5 end-to-end flow.
**Upstream**: `docs/PM/IoT/AGENT-PROMPT.md` deliverable 5,
`docs/Designs/IoT/Active/ProtocolStack.md` (LwM2M/CoAP Block),
`docs/Designs/IoT/Active/HardwareAbstractionLayer.md` (Flash effect),
...
survive. Each is a testable assertion — see
`CrossArchitectureTestStrategy.md` for the scripted QEMU tests
that exercise them.
