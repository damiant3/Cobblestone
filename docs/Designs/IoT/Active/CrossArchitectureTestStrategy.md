...
**Status**: Partially shipped -- cross-arch test results recorded (docs/Test/*cross_results.md); ARM64 + RISC-V both at 135/135 parity. Pending: fully formalized gate strategy.
