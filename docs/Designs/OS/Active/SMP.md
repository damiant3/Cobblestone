...
**Date**: 2026-06-17
**Author**: fester
**Status**: Shipped (x86-64) -- all 5 phases live: atomics (CL 4626), AP bootstrap, per-core scheduler, per-core heap, IPI + lock-free channels. Pending: ARM64/RISC-V atomic codegen.
