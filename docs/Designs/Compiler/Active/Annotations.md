...
Discussion, Historian, MutationLog, RepoProtocol, etc.) with tests. The
...
chapters; freshly renamed from `annotations/` in CL 1201) and
`docs/Active/Compiler/Annotations.md` (this document, 413 lines
...
- Inbound references checked: `docs/Designs/Build.md` line 40 (the
  `annotate.ps1` row) updated in the same CL to point at this
  addendum.
