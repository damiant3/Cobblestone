...
## Current Results (updated 2026-06-28, CL 6287)

| Metric | ARM64 | RISC-V | x86-64 |
|---|---|---|---|
| Tests total | 154 | ~153 | ~193 |
| Verified pass | **135 (100%)** | **135 (100%)** | ~183 |
| Compile-only pass | 2 | ~2 | 3 |
| Skipped | 17 | ~18 | 10 |
| Fail | **0** | **0** | 0 |

Both ARM64 (CL 6111) and RISC-V (CL 6287) reached full 135/135 parity
with the x86-64 battery. This tracker is archived as complete.
