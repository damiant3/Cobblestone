...
**Date:** 2026-06-20
**Agent:** val
**Status: NOT BEING BUILT.** The ARM64/RISC-V codegen-plug work this argues for
was dropped by Damian on 2026-07-23 (*"never well scoped or surveyed"*), and the
allocator it asks for closes into `MiddleEnd.md` step 5, which went with it.
Moved to `Done/` 2026-07-27 (blu). The thesis is not refuted, it is unfunded;
if the plugs are ever picked up again this is the argument to start from.

**Status when it was current:** Design justification. Still unbuilt -- the thesis holds. No
