...
**Retired to Done 2026-08-05 (Damian's ruling).** The inline trying / falling back to / on failure form is shipped and documented; the strategy / resolve / Criticality superstructure was never built and is retired with this filing. A relaunch starts from the open questions below.
