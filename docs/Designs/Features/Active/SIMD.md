...
Active design. No implementation yet. The x86-64 backend has scalar
SSE2 (XMM0/XMM1 for Real type arithmetic) but no packed/vector
operations, no VEX/EVEX encoding, no NEON/SVE, no RISC-V V.
