...
parser feature, a decision for Damian.
...
stage 3's row-le must not re-trip, and the staged fix plan are
tracked with executable probes in `codex/test/`. Listed here only
