...
**Status:** Engineering proposal. Adopts the discipline named in
`//Theory/Phases.md` and specifies how Codex's compiler phases would
implement it concretely. This document is the "how" that complements
the theory document's "why." Written 2026-04-24.
