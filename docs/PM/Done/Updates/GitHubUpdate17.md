...
- **Configurable surveys.** Phase deck multipliers in BuildSettings.codex. Deck overflow downgraded to warning.
- **Escape invariant (CDX9003).** Seal-time scan for deck-to-bivy pointers. PARSE/SCOPE compact disabled (127K violations).
