...
- **SparkServer** -- Bare-metal HTTP server: a self-contained page and the JSON API, plus static files from a FAT16 volume
...
Full -- All 87 .codex files use standard chapter/section/cite structure, fixed-point integer arithmetic, and effect-typed I/O. The software rasterizer targets Framebuf/GOP and binary formats are produced by dedicated export modules. **The browser half is gone (2026-09-02):** the WebGPU studio was a second, independent implementation of Spark rather than anything generated from these chapters, and it was deleted with its build script and its page glue. What runs is the desktop app.
