...
# Stage 1 ELF compiles source to ELF, both ELFs must be byte-
# identical. This is NOT pingpong (pingpong = bootstrap 2).
set -euo pipefail
...
echo "╔═══════════════════════════════════════════════════╗"
echo "║  Bootstrap 3 (bare-metal to ELF)                  ║"
echo "╚═══════════════════════════════════════════════════╝"
date
echo ""
...
run_binary_stage() {
    ...
    local raw_output="/tmp/bs3-raw-${stage}-$$"
    local pipe="/tmp/bs3-pipe-$$"
    local parse_out="/tmp/bs3-parse-${stage}-$$"
