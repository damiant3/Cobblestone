...
public sealed class JavaEmitter : IRExprTextEmitter, ICodeEmitter
{
    ...
    void EmitDefinition(StringBuilder sb, IRDefinition def)
    {
        ...
        string returnType = def.IsEffectfulDefinition() ? "void" : EmitReturnType(def);
    ...
    string EmitReturnType(IRDefinition def) => EmitType(def.PureReturnType());
    ...
    [
        ...
        "new", "this", "super", "null", "true", "false", "int",
        "long", "double", "boolean", "char", "byte", "short",
        "float", "abstract", "final", "native", "synchronized",
        "volatile", "transient", "throws", "try", "catch", "finally",
        "import", "package", "public", "private", "protected",
        "interface", "extends", "implements", "instanceof", "enum",
        "default", "assert", "throw", "var", "record", "sealed",
        "yield", "permits",
    ];
