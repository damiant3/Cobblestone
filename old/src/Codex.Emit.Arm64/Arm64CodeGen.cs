...
sealed class Arm64Config : RegisterAllocatorConfig
{
    public override string TargetName => "arm64";
    public override uint HeapReg => Arm64Reg.X28;
}
...
sealed class Arm64CodeGen
{
    ...
    static readonly Arm64Config s_config = new();
    static readonly uint HeapReg = s_config.HeapReg;
